...
-- BufferLine
map('n', '<leader>co', '<cmd>BufferCloseAllButCurrentOrPinned<CR>')
map('n', '<leader>cr', '<Cmd>BufferCloseBuffersRight<CR>')
map('n', '<leader>cl', '<Cmd>BufferCloseBuffersLeft<CR>')
map('n', 'c;', '<cmd>BufferCloseAllButPinned<CR>')
map('n', 'mr', '<Cmd>BufferMoveNext<CR>')
map('n', 'ml', '<Cmd>BufferMovePrevious<CR>')
map("n", "<TAB>", "<cmd>BufferNext<CR>")
map("n", "<leader><TAB>", "<cmd>BufferPrevious<CR>")
